// React is available globally via CDN script tags
...
export default function MascotOverlay({ message, visible, position }) {
...
// expose component globally so non-module scripts can use it
